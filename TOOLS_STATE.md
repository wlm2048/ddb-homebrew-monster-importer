...
- [x] Add tested fixture (`fixtures/monsters/gutterwight.json`)
...
`fixtures/monsters/gutterwight.json` — a CR 5 undead with traits, recharge action, sub-page data (senses, skills, movement, languages). Use as a reference when building your own JSON.